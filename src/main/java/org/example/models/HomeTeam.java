...
public class HomeTeam{
    ...
    public HomeTeam(String name, String slug, String shortName, Sport sport, int userCount, String nameCode, boolean disabled, boolean national, int type, int id, Country country, ArrayList<Object> subTeams, TeamColors teamColors, FieldTranslations fieldTranslations) {
        this.name = name;
        this.slug = slug;
